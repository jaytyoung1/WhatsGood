...
public class ListsFragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        Restaurant slate = new Restaurant("The Slate Pub", "http://slatepub.com");
        ...
        Restaurant detzis = new Restaurant("Detzi's Tavern", "http://www.detzistavern.com");
        ...
        Restaurant scorecard = new Restaurant("Scorecard Sports Bar & Grill", "http://www.scorecardbar.com");
